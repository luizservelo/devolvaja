...
<main>
    <section class="banner owl-carousel owl-theme">
        ...
        <div class="item" style="background-image: linear-gradient(rgba(31, 26, 78, .5),rgba(31, 26, 78, .5)), url(assets/images/banner2.png)">
            <h1>Realizamos a coleta do seu modem tv/internet sem uso,
                <br>
